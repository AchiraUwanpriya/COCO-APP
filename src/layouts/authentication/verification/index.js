...
const Verification = () => {
  ...
  async function handleClick() {
    if (!userInptOTP || userInptOTP.length < 5) {
...
//   try {
//     // Token as-is — UrlTokenEncode format preserve
//     const cleanToken = token?.trim() ?? "";

//     const response = await fetch("http://localhost:51976/Login/VerifyOTP", {
//       method: "POST",
...
//     if (data.StatusCode === 200 && data.Message === "Login Success") {
//       handleVerification(useData, cleanToken, navigate);
//     } else {
